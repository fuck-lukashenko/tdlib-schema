module TD::Types
  ...
  # @attr used_sender_id [TD::Types::MessageSender] Identifier of the message sender used by the current user to add
  #   the reaction; null if unknown or the reaction isn't chosen.
  ...
  class MessageReaction < Base
    ...
    attribute :used_sender_id, TD::Types::MessageSender
